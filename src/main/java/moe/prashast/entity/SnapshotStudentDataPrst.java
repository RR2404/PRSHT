...
@Entity
@Table(
        name = "snapshot_student_data_prst",
        uniqueConstraints = {
                @UniqueConstraint(
                        name = "un_snap_stu_data_pen",
                        columnNames = "student_pen"
                )
        }
)
public class SnapshotStudentDataPrst {

    @EmbeddedId
    private SnapshotStudentDataPrstId id;
